...
public class Eleicao{
     ...
     *
     * @param tipoCandidatoRequerido String com o tipo de candidato fornecido no terminal (--estadual ou --federal)
     ...
     */
    public Eleicao(String tipoCandidatoRequerido, String diretorioArquivoCandidatos, String diretorioArquivoVotos) {
        
        String tipoCargo = tipoCandidatoRequerido.substring(2).toUpperCase();
        
        Leitura.arquivoCandidatos(diretorioArquivoCandidatos, this, tipoCargo);
        Leitura.arquivosVotacao(diretorioArquivoVotos, this, tipoCargo);
    }

    /**
     * Associa o candidato ao partido com base em seu número de partido, criando e populando
     * objetos Partidos correspondentes para cada número de partido único encontrado nos candidatos.
     */
    public void setPartidos(Candidato c){
    ...
    */
    ...
    public void addCandidato(String idxCandidato, Candidato candidato) {
        this.candidatos.put(idxCandidato, candidato);
    }
